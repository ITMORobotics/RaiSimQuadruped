...
anymal_urdf_file = os.path.dirname(os.path.abspath(__file__)) + "/../raisimLib/rsc/anymal/urdf/anymal.urdf"
laikago_urdf_file = os.path.dirname(os.path.abspath(__file__)) + "/../raisimLib/rsc/laikago/laikago.urdf"
atlas_urdf_file = os.path.dirname(os.path.abspath(__file__)) + "/../raisimLib/rsc/atlas/robot.urdf"
monkey_file = os.path.dirname(os.path.abspath(__file__)) + "/../raisimLib/rsc/monkey/monkey.obj"
